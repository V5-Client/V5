    ...
    if (!args || args.length === 0) {
        ...
        const showcaseMessages = {
            ...
            WARNING: {
                ...
                description: "You're lagging, be cautious",
            },
            ERROR: {
                title: 'Error Occurred',
                description: 'Failed to save settings or something',
            },
            DANGER: {
                title: 'Critical Failure',
                description: 'GASP, PRETEND SOMETHING HAPPENED!',
            },
        };
