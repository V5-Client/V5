...
const applyUngrab = () => {
    ...
    if (!IS_MC_26_3 && isLinux) GLFW.glfwSetInputMode(mc.getWindow().handle(), GLFW.GLFW_CURSOR, GLFW.GLFW_CURSOR_NORMAL);
};
...
const applyRegrab = () => {
    ...
    if (!IS_MC_26_3 && isLinux) GLFW.glfwSetInputMode(mc.getWindow().handle(), GLFW.GLFW_CURSOR, GLFW.GLFW_CURSOR_DISABLED);
};
