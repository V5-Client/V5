...
export const showNotification = (title, description, type = 'SUCCESS', duration = 5000) => notify(title, description, type, duration);
...
export const findItem = (categoryName, itemName) => Categories.findItem(categoryName, itemName);
